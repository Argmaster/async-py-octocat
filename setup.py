...
PACKAGE_NAME = "async_py_octocat"
SOURCE_DIR = REPOSITORY_ROOT_DIR / "source" / PACKAGE_NAME

# Regular expression is used to extract version from async_py_octocat/__init__.py file
...
PROJECT_URLS = {
    "GitHub": "https://github.com/Argmaster/async_py_octocat",
}
KEYWORDS = [
    "python-3",
    "python-3.7",
...
ENTRY_POINTS = {
    "console_scripts": ["async_py_octocat=async_py_octocat.__main__:main"]
}
